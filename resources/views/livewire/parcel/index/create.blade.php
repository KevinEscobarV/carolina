        ...
        <div class="grid grid-cols-6 gap-6">
            ...
            <div class="col-span-6">
                <div class="flex items-center gap-3 mt-6">
                    ...
                    <h2 class="text-xl text-gray-800 dark:text-gray-200 leading-tight">
                        Escrituración <span class="text-sm text-gray-500 dark:text-gray-400">(Opcional)</span>
                    </h2>
                </div>
            </div>
            ...
            <div class="col-span-6 sm:col-span-3">
                <x-wireui-select label="Promesa o escritura" wire:model="form.promise_id"
                    placeholder="Seleccione una escritura" :async-data="route('api.promises.index')" option-label="deed_number"
                    option-value="id" />
            </div>
        </div>
